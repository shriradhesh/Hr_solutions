   ...
   // Api for cms_employee_outsourcing
    ...
    // Api for cms_Hr_teleconsultation
     ...
     // Api for exports all clients
        ...
        // Api for getService
        router.get('/getService_admin/:adminId', authUser, role_check('/getService_admin'),   Admin_and_staffController.getService_admin )
        // Api for  getHr_consultancy_Details
        ...
        router.get('/getJobs_posted_procedure_section1_admin/:adminId', authUser, role_check('/getJobs_posted_procedure_section1_admin'),  Admin_and_staffController.getJobs_posted_procedure_section1_admin) 

        // Api for get_cms_need_any_job_section_admin
        router.get('/get_cms_need_any_job_section_admin/:adminId', authUser, role_check('/get_cms_need_any_job_section_admin'),  Admin_and_staffController.get_cms_need_any_job_section_admin) 
        // Api for get_cms_post_your_job_admin
        router.get('/get_cms_post_your_job_admin/:adminId', authUser, role_check('/get_cms_post_your_job_admin'),  Admin_and_staffController.get_cms_post_your_job_admin) 
        // Api for get_cms_job_market_data_admin
        router.get('/get_cms_job_market_data_admin/:adminId', authUser, role_check('/get_cms_job_market_data_admin'),  Admin_and_staffController.get_cms_job_market_data_admin) 
        ...
        router.get('/getcms_headquarter_admin/:adminId', authUser, role_check('/getcms_headquarter_admin'),  Admin_and_staffController.getcms_headquarter_admin) 
        ...
        router.get('/get_admin_term_condition_admin/:adminId', authUser, role_check('/get_admin_term_condition_admin'),  Admin_and_staffController.get_admin_term_condition_admin) 
