...
const role_check = require('../middleware/role_check') 
        ...
        // Api for active_inactive_Hr
                     router.post('/active_inactive_Hr/:hr_id', authUser, role_check('/active_inactive_Hr'), Admin_and_staffController.active_inactive_Hr)
              // forget password Api -- 
...
router.post('/adminResetPass/:adminId', Admin_and_staffController.adminResetPass)
        ...
        // Api for getAllFemale_Candidate
                     router.get('/getAllFemale_Candidate', authUser, role_check('/getAllFemale_Candidate'), Admin_and_staffController.getAllFemale_Candidate)
        // APi for candidate_recruitment_process
                     router.post('/candidate_recruitment_process/:candidateId', authUser, role_check('/candidate_recruitment_process'), Admin_and_staffController.candidate_recruitment_process)
        // Api for fav_job
        ...
        // Api for get All_candidates
                     router.get('/getAll_candidates', authUser, role_check('/getAll_candidates'), Admin_and_staffController.getAll_candidates) 
        // Api for candidate_cv_rating
                     router.get('/candidate_cv_rating/:candidate_id', authUser, role_check('/candidate_cv_rating'),  Admin_and_staffController.candidate_cv_rating) 
     ...
     // Api for get_emp_privacy_policy
                          router.get('/get_admin_privacy_policy/:adminId', authUser, role_check('/get_admin_privacy_policy'), Admin_and_staffController.get_admin_privacy_policy)
     ...
     // Api for create_term_condition
      ...
      // Api for get_emp_term_condition
                          router.get('/get_admin_term_condition/:adminId',  authUser, role_check('/get_admin_term_condition'),  Admin_and_staffController.get_admin_term_condition)
        ...
        // Api for getService
                        router.get('/getService/:adminId', authUser, role_check('/getService'), Admin_and_staffController.getService )
       ...
       // Api for get_FAQdetails
                        router.get('/get_FAQdetails', authUser, role_check('/get_FAQdetails'), Admin_and_staffController.get_FAQdetails)
       // Api for DeleteFAQ
        ...
        // Api for DeleteContactUS
                        router.delete('/DeleteContactUS/:contact_id' , authUser, role_check('/DeleteContactUS'), Admin_and_staffController.DeleteContactUS)
   ...
   // Api for create Testimonial for cms
    ...
    // Api for getJobs_posted_procedure_section1
                router.get('/getJobs_posted_procedure_section1/:adminId', authUser, role_check('/getJobs_posted_procedure_section1'),  Admin_and_staffController.getJobs_posted_procedure_section1)
    ...
    // Api for get_cms_need_any_job_section
                router.get('/get_cms_need_any_job_section/:adminId', authUser, role_check('/get_cms_need_any_job_section'), Admin_and_staffController.get_cms_need_any_job_section)
    ...
    // Api for get_cms_post_your_job
               router.get('/get_cms_post_your_job/:adminId', authUser, role_check('/get_cms_post_your_job'),  Admin_and_staffController.get_cms_post_your_job)
    ...
    // Api for get_cms_job_market_data
               router.get('/get_cms_job_market_data/:adminId', authUser, role_check('/get_cms_job_market_data'),  Admin_and_staffController.get_cms_job_market_data)
    ...
    // Api for getcmsBlog_section1
               router.get('/getcmsBlog_section1', authUser, role_check('/getcmsBlog_section1'), Admin_and_staffController.getcmsBlog_section1)
    ...
    // Api for  getBlogDetails
               router.get('/getBlogDetails',authUser, role_check('/getBlogDetails'),  Admin_and_staffController.getBlogDetails) 
    ...
    // Api for getcms_headquarter
                router.get('/getcms_headquarter/:adminId', authUser, role_check('/getcms_headquarter'),  Admin_and_staffController.getcms_headquarter)
    ...
    // Api for  getHr_consultancy_Details
                 router.get('/getHr_consultancy_Details', authUser, role_check('/getHr_consultancy_Details'),  Admin_and_staffController.getHr_consultancy_Details)
   // Api for cms_Training_development
    ...
    // Api for get_training_development_Details
                router.get('/get_training_development_Details', authUser, role_check('/get_training_development_Details'),  Admin_and_staffController.get_training_development_Details) 
   ...
   // Api for get_recruitment_selection_Details
               router.get('/get_recruitment_selection_Details', authUser, role_check('/get_recruitment_selection_Details'),  Admin_and_staffController.get_recruitment_selection_Details)
   // Api for cms_employee_outsourcing
    ...
    // Api for get_outsourcing_Details
               router.get('/get_outsourcing_Details', authUser, role_check('/get_outsourcing_Details'),  Admin_and_staffController.get_outsourcing_Details)      
    // Api for cms_Hr_teleconsultation
     ...
     // Api for get_hr_teleconsultation_Details
               router.get('/get_hr_teleconsultation_Details', authUser, role_check('/get_hr_teleconsultation_Details'), Admin_and_staffController.get_hr_teleconsultation_Details)
     ...
     // Api for get_ourMission_details
               router.get('/get_ourMission_details', authUser, role_check('/get_ourMission_details'),  Admin_and_staffController.get_ourMission_details)
     // Api for cms_aboutUs
                router.post('/cms_aboutUs', authUser, role_check('/cms_aboutUs'),  Admin_and_staffController.cms_aboutUs)
     // Api for get_aboutUS_details
                 router.get('/get_aboutUS_details', authUser, role_check('/get_aboutUS_details'),  Admin_and_staffController.get_aboutUS_details)
      // Api for cms_our vission 
                ...
                // Api for get_aboutUS_details
                            router.get('/get_ourVission_details', authUser, role_check('/get_ourVission_details'),  Admin_and_staffController.get_ourVission_details)
      // Api for cms_our commitment
                ...
                // Api for get_ourCommitment_details
                            router.get('/get_ourCommitment_details', authUser, role_check('/get_ourCommitment_details'),  Admin_and_staffController.get_ourCommitment_details)
      // Api for get started today
                router.post('/cms_get_started_today', authUser, role_check('/cms_get_started_today'),  Admin_and_staffController.cms_get_started_today)
                // Api for get_ourCommitment_details
                            router.get('/get_started_todayDetails', authUser, role_check('/get_started_todayDetails'),  Admin_and_staffController.get_started_todayDetails)
           ...
           // Api for getDetails_why_choose_us
               router.get('/getDetails_why_choose_us', authUser, role_check('/getDetails_why_choose_us'), Admin_and_staffController.getDetails_why_choose_us)
        ...
        // Api for get_cms_elite_talent_pool
                 router.get('/get_cms_elite_talent_pool', authUser, role_check('/get_cms_elite_talent_pool'),  Admin_and_staffController.get_cms_elite_talent_pool)
        ...
        // Api for get_cms_footer_content
                  router.get('/get_cms_footer_content',  authUser, role_check('/get_cms_footer_content'), Admin_and_staffController.get_cms_footer_content)
        ...
        // Api for get_acadmic_credentials_verifier
                   router.get('/get_acadmic_credentials_verifier', authUser, role_check('/get_acadmic_credentials_verifier'),  Admin_and_staffController.get_acadmic_credentials_verifier)
        ...
        // Api for get_cms_Home
                 router.get("/get_cms_Home",  authUser, role_check('/get_cms_Home'), Admin_and_staffController.get_cms_Home)
       ...
       // Api for calculate_EOSB
        ...
        // Api for jobseeker_count
                router.post('/jobseeker_count', authUser, role_check('/jobseeker_count'), Admin_and_staffController.jobseeker_count)
        // Api for getclient_count
                router.post('/getclient_count', authUser, role_check('/getclient_count'),Admin_and_staffController.getclient_count)
        // Api for get_talent_pool_count
                router.post('/get_talent_pool_count', authUser, role_check('/get_talent_pool_count'), Admin_and_staffController.get_talent_pool_count)
        // Api for get_female_screened_count
                router.post('/get_female_screened_count', authUser, role_check('/get_female_screened_count'),  Admin_and_staffController.get_female_screened_count)
        // Api for jobseeker_count_city_wise
                router.post('/jobseeker_count_city_wise', authUser, role_check('/jobseeker_count_city_wise'),  Admin_and_staffController.jobseeker_count_city_wise)


      // Api for news letter

               router.post('/newsLetter', authUser, role_check('/newsLetter'),Admin_and_staffController.newsLetter)
      // Api for getAll_newsLetter
        ...
        // Api for all_carrer_details
                router.get('/all_carrer_details', authUser, role_check('/all_carrer_details'),  Admin_and_staffController.all_carrer_details)
        ...
        // Api for generate sample file
                router.get("/generate_sampleFile", authUser, role_check('/generate_sampleFile'), Admin_and_staffController.generate_sampleFile)
        ...
        // Api for get alljobSkills
                router.get("/alljobSkills", authUser, role_check('/alljobSkills'),  Admin_and_staffController.alljobSkills)
        ...
        // Api for getJs
                router.post("/getJs",  authUser, role_check('/getJs'), Admin_and_staffController.getJs)
        ...
        router.put(
         ...
         // Api for delete_course
          ...
          router.get('/all_enq_of_courses', authUser, role_check('/all_enq_of_courses'),  Admin_and_staffController.all_enq_of_courses)
        ...
        router.get('/get_quiz_test_of_course/:test_id', authUser, role_check('/get_quiz_test_of_course'), Admin_and_staffController.get_quiz_test_of_course)
        // Api for course_quiz
                router.get('/course_quiz/:course_id', authUser, role_check('/course_quiz'), Admin_and_staffController.course_quiz)
        ...
        router.delete('/delete_test/:test_id', authUser, role_check('/delete_test'), Admin_and_staffController.delete_test)
         ...
         router.get('/all_topics_of_course/:course_id',  authUser, role_check('/all_topics_of_course'),  Admin_and_staffController.all_topics_of_course)
 ...
 router.post('/update_question_of_quiz/:test_id/:questionId' ,  authUser, role_check('/update_question_of_quiz'),  Admin_and_staffController.update_question_of_quiz )
   ...
   router.get('/get_all_courses_details', authUser, role_check('/get_all_courses_details'),  Admin_and_staffController.get_all_courses_details)

   // Api for jobseeker_count_of_client_job
   router.get('/jobseeker_count_of_client_job/:clientId' , authUser, role_check('/jobseeker_count_of_client_job'),  Admin_and_staffController.jobseeker_count_of_client_job)
   ...
   router.get('/emailContent_of_title/:email_title', authUser, role_check('/emailContent_of_title'),  Admin_and_staffController.emailContent_of_title)
